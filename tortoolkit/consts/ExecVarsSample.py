try:
    ...
    class ExecVars:
        ...
        API_HASH = "3cda969538e15bafec5174c72e51590d"
        API_ID = 23552168 
        BOT_TOKEN = "5501035838:AAH5RG5ghc6Aqice7nODoAWd0mijesIFCTI"
        BASE_URL_OF_BOT = "http://54.88.109.48"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [-1001815276403]
        OWNER_ID = 1684353159
